...
public class SecuritystaffWorkerController extends AbstractDtController {
	...
	protected MsgResponse login(String phoneNum, String password, String tokenId) {
		...
		try{
			response = this.workerService.login_tx(phoneNum, password, tokenId, WorkType.TYPE_SECURIY);
		}catch(Exception e){
